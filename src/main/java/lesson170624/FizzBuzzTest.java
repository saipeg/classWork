...
public class FizzBuzzTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(333), "Fizz"));
        ...
        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(100), "Buzz"));
        System.out.println(Asserts.assertNotEquals(FizzBuzz.fizzBuzz(1), "Buzz"));

        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(15), "FizzBuzz"));
        System.out.println(Asserts.assertEquals(FizzBuzz.fizzBuzz(300), "FizzBuzz"));
        System.out.println(Asserts.assertNotEquals(FizzBuzz.fizzBuzz(11), "FizzBuzz"));
        ...
        System.out.println(Asserts.assertNotEquals(FizzBuzz.fizzBuzz(15), "15"));
